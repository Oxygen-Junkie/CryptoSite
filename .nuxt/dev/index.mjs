globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/node-fetch-native@1.0.2/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/h3@1.6.4/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/vue@3.2.47/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/destr@1.2.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/unenv@1.2.2/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/hookable@5.5.2/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/scule@1.0.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/ohash@1.0.0/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/FarmUser/Desktop/CryptoSite/node_modules/.pnpm/radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"naiveUI":{"themeOverrides":""}}};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/FarmUser/Desktop/CryptoSite/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\FarmUser\\Desktop\\CryptoSite","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\FarmUser\\Desktop\\CryptoSite\\src\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\FarmUser\\Desktop\\CryptoSite\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\FarmUser\\Desktop\\CryptoSite\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const script = "\"use strict\";const w=window,de=document.documentElement,knownColorSchemes=[\"dark\",\"light\"],preference=window.localStorage.getItem(\"color-mode\")||\"system\";let value=preference===\"system\"?getColorScheme():preference;const forcedColorMode=de.getAttribute(\"data-color-mode-forced\");forcedColorMode&&(value=forcedColorMode),addColorScheme(value),w[\"__NUXT_COLOR_MODE__\"]={preference,value,getColorScheme,addColorScheme,removeColorScheme};function addColorScheme(e){const o=\"\"+e+\"\",t=\"\";de.classList?de.classList.add(o):de.className+=\" \"+o,t&&de.setAttribute(\"data-\"+t,e)}function removeColorScheme(e){const o=\"\"+e+\"\",t=\"\";de.classList?de.classList.remove(o):de.className=de.className.replace(new RegExp(o,\"g\"),\"\"),t&&de.removeAttribute(\"data-\"+t)}function prefersColorScheme(e){return w.matchMedia(\"(prefers-color-scheme\"+e+\")\")}function getColorScheme(){if(w.matchMedia&&prefersColorScheme(\"\").media!==\"not all\"){for(const e of knownColorSchemes)if(prefersColorScheme(\":\"+e).matches)return e}return\"light\"}\n";

const _VmW3o9FVs8 = (function(nitro) {
...
const _lazy_2JJboP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2JJboP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2JJboP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/FarmUser/Desktop/CryptoSite/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/FarmUser/Desktop/CryptoSite/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
