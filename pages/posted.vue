...
<template>
  <div id="home" class="container mx-auto mb-3">
    <Container>
      ...
      <div v-if="tagLoaded === false" class="loading">
        <div class="bg-red shadow p-1 mt-1 rounded w-100">
          ...
          <Container>
            <h4>
              <ion-icon name="send-outline" />&nbsp; Запрос на продажу в
              количестве 10 шт.
            </h4>
            <p class="card-text text-muted">
              ...
              <input
                type="text"
                class="w-50"
                placeholder="проспект Столыпина, дом 1, квартира 9"
              />
              &nbsp; Время
              <input type="text" placeholder="Пн-Пт с 9:00 до 18:00" />
            </p>
          ...
          <Container>
            <h4>
              <ion-icon name="cash-outline" />&nbsp; Активная сделка на продажу
              в количестве 10 шт.
            </h4>
            Код:<span class="text-danger"> 412178 </span>
          </Container>
        </div>
      </div>
    </Container>
    <Container>
      <h1>
        <ion-icon name="document-attach-outline" /> Установить новое объявление
        о продаже товара
      </h1>
